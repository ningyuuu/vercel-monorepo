...
import { Board, useBoardState, printState, X } from "../Board";
...
export default function Home() {
  ...
  if (current !== humanPlayer && !winState) {
    const move = minimax({ state, current, winState, play }, humanPlayer);
    play(move);
  }
      ...
      <main className="mx-auto flex w-full max-w-3xl flex-col gap-6 px-4 py-12">
        <Card>
          <CardHeader className="items-center text-left">
            <CardTitle className="text-3xl">Against Computer</CardTitle>
